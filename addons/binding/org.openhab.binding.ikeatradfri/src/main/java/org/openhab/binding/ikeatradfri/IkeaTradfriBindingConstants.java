...
public class IkeaTradfriBindingConstants {
    ...
    public static final Set<ThingTypeUID> SUPPORTED_BULB_TYPES_UIDS = ImmutableSet.of(THING_TYPE_WW_BULB, THING_TYPE_WS_BULB);
    public static final Set<ThingTypeUID> SUPPORTED_DEVICE_TYPES_UIDS = ImmutableSet.of(THING_TYPE_WW_BULB, THING_TYPE_DIMMER, THING_TYPE_CONTROLLER, THING_TYPE_DIMMER);
